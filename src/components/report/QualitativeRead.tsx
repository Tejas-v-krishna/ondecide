    ...
    <div className="rounded-xl border border-zinc-800/60 bg-zinc-950 overflow-hidden">
      ...
      <div className="divide-y divide-zinc-800">
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-zinc-100 leading-relaxed">{data.managementAssessment}</p>
        </div>
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-zinc-100 leading-relaxed">{data.competitivePositioning}</p>
        </div>
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-zinc-100 leading-relaxed">{data.analystSentiment.synthesizedSummary}</p>
        </div>
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-zinc-100 leading-relaxed">{data.longTermInvestorLens}</p>
        </div>
      </div>
    </div>
  );
